...
class TestIngestors:
    ...
    @patch("mercadobitcoinapi.ingestors.DataIngestor._write_checkpoint", return_value=None)
    ...
    @patch("builtins.open", new_callable=mock_open, read_data="2021-06-25")
    @patch("mercadobitcoinapi.ingestors.DataIngestor._checkpoint_filename", return_value="foobar.checkpoint")
