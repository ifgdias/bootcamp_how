#crtl + E + T -> executar texto no terminal ativo
...
A combinação menos frequente é: {}
A combinação de pares, Impares e Primos mais frequente é : {} com a frequencia de {}
''').fomat(freq_nr[-1][0], freq_nr[0][0], resultado['Combinação'].values[-1], resultado['p_freq'].values[-1])
